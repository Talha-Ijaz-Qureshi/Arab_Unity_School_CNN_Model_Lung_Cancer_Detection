...
model = keras.models.load_model('2_best_trained.h5')
...
np.savetxt('2_best/scc_run/aca_list.txt', aca_list, fmt='%s')
np.savetxt('2_best/scc_run/n_list.txt', n_list, fmt='%s')
np.savetxt('2_best/scc_run/unclassified.txt', unclassified, fmt='%s')
